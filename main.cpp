...
int main() {
    ...
    list<string> menu = {" ","------------ ⋆｡°✩ MENU ✩°｡⋆ -------------", "1 - Cadastrar Astronauta", "2 - Cadastrar Voo", "3 - Adicionar Astronaura em voo", "4 - Remover Astronauta de um voo", "5 - Lançar um voo", "6 - Explodir voo","7 - Pousar","8 - Informacoes dos voo","9 - Mostrar passageiros mortos", "10 - Sair", "-----------------------------------------"," "};

    cout<< "Sistema de Gerenciamento de Viagens Espaciais"<< endl;
    int x = 0;
    int opcao;
