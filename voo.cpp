...
void Voo::adicionar(Astronauta* astronauta) {
    if (condicao == "planejado") {
        // Verifica se o astronauta ja esta na lista de passageiros
        for (auto& p : Passageiros) {
            if (p == astronauta) {
                cout << "O astronauta já está adicionado ao voo." << endl;
                return;
            }
        }
        ...
        cout << "Não é possível adicionar astronautas. O voo não está planejado." << endl;
    }
}
